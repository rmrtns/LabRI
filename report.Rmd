...
3. [dplyr: A Grammar of Data Manipulation.](https://cran.r-project.org/web/packages/dplyr) Version: `r packageDescription("dplyr")$Version`.
4. [DT: A Wrapper of the JavaScript Library 'DataTables'.](https://cran.r-project.org/web/packages/DT) Version: `r packageDescription("DT")$Version`.
5. [ggplot2: Create Elegant Data Visualisations Using the Grammar of Graphics.](https://cran.r-project.org/web/packages/ggplot2) Version: `r packageDescription("ggplot2")$Version`.
6. [kableExtra: Construct Complex Table with 'kable' and Pipe Syntax.](https://cran.r-project.org/web/packages/kableExtra/index.html) Version: `r packageDescription("kableExtra")$Version`.
7. [knitr: A General-Purpose Package for Dynamic Report Generation in R.](https://cran.r-project.org/web/packages/knitr/index.html) Version: `r packageDescription("knitr")$Version`.
...
10. [refineR: Reference Interval Estimation using Real-World Data.](https://cran.r-project.org/web/packages/refineR/index.html) Version: `r packageDescription("refineR")$Version`.
11. [shinyFeedback: Display User Feedback in Shiny Apps.](https://cran.rstudio.com/web/packages/shinyFeedback) Version: `r packageDescription("shinyFeedback")$Version`.
...
13. [waiter: Loading Screen for 'Shiny'.](https://cran.r-project.org/web/packages/waiter/index.html) Version: `r packageDescription("waiter")$Version`.
